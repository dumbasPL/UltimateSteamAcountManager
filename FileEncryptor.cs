...
namespace Steam_Desktop_Authenticator // yes i did not even bother to change the namespace (pasted cuz no point in reinventing AES)
{
    /// <summary>
    ...
    {
        private const int PBKDF2_ITERATIONS = 5000; //Set to 50k to make program not unbearably slow. May increase in future.
